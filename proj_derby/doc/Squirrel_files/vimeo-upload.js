    ...
    */
    ...
    var me = function(opts) {
        ...
        this.videoData = {
            ...
            'privacy.embed' : opts.private ? 'whitelist' : 'public'
        }
    ...
    */
    ...
    me.prototype.onUpdateVideoData_ = function(video_id) {
        ...
        xhr.onload = function(e) {
            ...
            if(this.embedDomain){
                var url = 'https://api.vimeo.com/videos/' + video_id + '/privacy/domains/' + this.embedDomain
                var httpMethod = 'PUT'
                var xhr = new XMLHttpRequest()
        ...
        console.log(this.videoData,'Video Data');
